...
- 🔲 Продуктивність під платний трафік. АКТУАЛЬНО (PSI 12.08.2026, mobile, Moto G Power / slow 4G):
  **89** ефективність, 100 доступність / найкращі практики / SEO.
  ...
  ✅ 12.08 знято два блокери LCP (d9a570a): H1 більше не ховається за opacity під час
  анімації, банер cookie звужено 680→560px, щоб не перехоплював LCP на себе (він був
  більший за заголовок). Плюс preconnect до googletagmanager і clarity. Перевірено на
  проді справжнім браузером: opacity=1, animation=heroRiseUp, max-width=560px, обидва
  preconnect у head. **Контрольний PSI ще не ганявся** — денна квота API вичерпана;
  перезаміряти й вписати сюди новий бал.
