...
posthog.init(${JSON.stringify(key)}, {
  ...
  // Опитувань PostHog ми не використовуємо, але SDK тягне surveys.js завжди —
  // 35 КБ і окрема довга задача на кожній сторінці, зокрема на посадкових з реклами
  // (заміряно 2026-09-07: TTI 4,8с, 4 довгі задачі, PostHog — найбільша з них).
  // Знадобляться опитування — прибрати цей рядок, іншого перемикача не треба.
