  ...
  return (
    <section id="contact" className="contact" ref={sectionRef}>
      ...
      <form className="contact-form animate-in" onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div className="contact-field">
          <input
            ...
            {...register('phone', {
              required: t('form.errorPhone'),
              pattern: {
                value: /^\+?[\d\s\-()]{7,18}$/,
                message: t('form.errorPhone'),
              },
            })}
          />
          {errors.phone && (
        ...
        {submitted && (
          <div className="contact-success">{t('form.success')}</div>
        )}
      ...
      <div className="contact-info animate-in">
        <a
          href="https://wa.me/380685026199"
          className="contact-link"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg className="contact-wa-icon" viewBox="0 0 24 24" fill="currentColor" width="20" height="20" style={{ marginRight: '8px', verticalAlign: 'middle' }}>
        ...
        <a
          href={t('info.telegramUrl')}
          className="contact-link contact-link-tg"
          target="_blank"
          rel="noopener noreferrer"
          aria-label={t('info.telegram')}
        >
